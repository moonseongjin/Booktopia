...
<body>
	<h3>내 상세 정보</h3>
<form name="frm_mod_member" action="${contextPath}/mypage/memberDelete.do">	
	<div id="detail_table">
		<table>
			<tbody>
				<tr class="dot_line">
					...
					<td>
						<input name="member_id" type="text" size="20" value="${memberInfo.member_id }"  />
					</td>
					 <td>
					</td>
				</tr>
		...
		<tr>
			<td >
				...
				<input name="btn_cancel_member" type="submit"  value="회원 탈퇴">
			</td>
		</tr>
	</table>
	</div>
