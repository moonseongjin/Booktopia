...
<body>
	<a class="cls1"
		href="javascript:fn_articleForm('${isLogOn}','${contextPath}/board/articleForm.do', 
			...
			style="text-align: left" class="cls2">게시판 글쓰기</p></a>
	<table style="margin-top: 3%" align="center" border="1" width="100%">
				...
				<c:forEach var="article" items="${articlesList}"
					...
					<tr align="center">
						...
						<td align='left' width="40%"><span
							style="padding-right: 20px"></span> <c:choose>
						...
						<c:if test="${id==article.id || id == 'admin'}">
							...
							<td width="10%"><a
								href="${contextPath}/board/removeArticle.do?articleNO=${article.articleNO}">삭제</a></td>
						</c:if>
					</tr>
				</c:forEach>
			</c:when>
