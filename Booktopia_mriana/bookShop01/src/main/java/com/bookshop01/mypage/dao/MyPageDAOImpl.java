...
public class MyPageDAOImpl implements MyPageDAO{
	...
	public void memberDelete(String member_id) throws DataAccessException {
		System.out.println("여기까지 오나?    " + member_id);
		 sqlSession.delete("mapper.mypage.memberDelete", member_id);
	}
